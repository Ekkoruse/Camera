        ...
        button= findViewById(R.id.btn_flash);
            ...
            public void onClick(View v) {
                    if(flash==1) {
                        ...
                        Toast.makeText(CustomCameraActivity.this,"on",Toast.LENGTH_SHORT).show();
                    ...
                    else if(flash==0)
                    {
                        ...
                        Toast.makeText(CustomCameraActivity.this,"torch",Toast.LENGTH_SHORT).show();
                    ...
                    else
                    {
                        ...
                        Toast.makeText(CustomCameraActivity.this,"off",Toast.LENGTH_SHORT).show();
