...
public class RecordVideoActivity extends AppCompatActivity {
    ...
    private void openVideoRecordApp() {
        Intent takeV = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
        if(takeV.resolveActivity(getPackageManager())!=null)
        {
            startActivityForResult(takeV,REQUEST_VIDEO_CAPTURE);
        }
    }
}
